...
interface ATSDiagnosticProps {
  resumeId: number
  autoGeneratedExplanation?: DiagnosticResult | null
  loadingExplanation?: boolean
  onClearAutoExplanation?: () => void
}
...
export function ATSDiagnostic({ 
  resumeId, 
  autoGeneratedExplanation, 
  loadingExplanation = false,
  onClearAutoExplanation 
}: ATSDiagnosticProps) {
  ...
  // Use auto-generated explanation if available, otherwise use manual result
  const displayResult = autoGeneratedExplanation || result
  const displayLoading = loadingExplanation || loading
  ...
  return (
    <div className="space-y-4 p-4">
      {/* Header - Only show if no auto-generated explanation */}
      {!autoGeneratedExplanation && (
      ...
      {/* Auto-generated explanation banner */}
      {autoGeneratedExplanation && (
            ...
            <div className="flex items-start gap-2 flex-1">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-blue-700">
                  Clicked an issue? Here's why it happened and how to fix it.
                </p>
              </div>
            </div>
            {onClearAutoExplanation && (
              <button
                onClick={onClearAutoExplanation}
      ...
      {/* Auto-generated Results - Show first if exists */}
      {autoGeneratedExplanation && (
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="flex items-start space-x-3 mb-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-700 whitespace-pre-line">
                  {autoGeneratedExplanation.explanation}
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Location */}
          {autoGeneratedExplanation.location && (
          ...
          {/* Recommendations */}
          {autoGeneratedExplanation.recommendations && autoGeneratedExplanation.recommendations.length > 0 && (
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <ol className="space-y-2">
                    {autoGeneratedExplanation.recommendations.map((rec, idx) => (
      ...
      {/* Input Form - Always show, but below auto-generated results if they exist */}
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
        <label className="block text-sm font-medium text-gray-700 mb-2">
          {autoGeneratedExplanation ? 'Ask a follow-up question:' : 'Describe the issue you see:'}
        </label>
        <textarea
          value={prompt}
          onChange={(e) => setPrompt(e.target.value)}
          placeholder={autoGeneratedExplanation 
            ? "e.g., 'How can I fix this specific issue?' or 'What should I change?'"
            : "e.g., 'I'm missing 5 skills' or 'My email isn't showing up'"
          }
        ...
        <button
          type="submit"
          disabled={displayLoading || !prompt.trim()}
      ...
      {/* Manual Results - Only show if user manually submitted (not auto-generated) */}
      {result && !autoGeneratedExplanation && (
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          {/* Explanation */}
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-start space-x-3 mb-3">
